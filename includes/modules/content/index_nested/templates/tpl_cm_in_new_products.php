...
<div class="col-sm-<?php echo $content_width; ?> cm-in-new-products">
    ...
    <h3 class="h3"><?php
        ...
        echo sprintf(MODULE_CONTENT_IN_NEW_PRODUCTS_HEADING, $formatter->format(time()));
    ?></h3>
