    ...
    <div class="row list-group">
        ...
        <div class="col-sm-<?php echo $product_width; ?>">
            <div class="thumbnail equal-height">
                ...
                <div class="caption">
                    <h5 class="h3 text-center" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="url" href="<?php echo tep_href_link('product_info.php', 'products_id=' . $orders['products_id']); ?>"><span itemprop="name"><?php echo $orders['products_name']; ?></span></a>
