...
class splitPageResults
{
    ...
    function display_count($query_numrows, $max_rows_per_page, $current_page_number, $text_output)
    {
        ...
        $from_num = is_numeric($from_num) ? (string)$from_num : $from_num;
        $to_num = is_numeric($to_num) ? (string)$to_num : $to_num;
        $query_numrows = is_numeric($query_numrows) ? (string)$query_numrows : $query_numrows;

        // Use your custom sprintf
        $output = sprintf($text_output, $from_num, $to_num, $query_numrows);
